...
import TakingNotes from "../public/images/landing-art.webp";
      ...
      <section className="text-gray-600 body-font">
        <div className="container flex flex-col items-center mx-auto md:flex-row">
          <div className="flex flex-col items-center mb-16 text-center lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left md:mb-0">
            <div className="mb-4 font-medium text-gray-900 title-font">
          ...
          <div className="w-72 lg:max-w-lg lg:w-full md:w-1/2">
            <Image
              alt="Illustration"
              className="hidden object-cover object-center rounded pointer-events-none select-none -z-10 md:block"
              src={TakingNotes}
            />
          </div>
        </div>
